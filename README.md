...
- **21 read tools:** authenticated health checks, account inspection, performance
  reports, Keyword Planner and raw GAQL with bounded, paginated responses.
...
Read the [write guide](docs/writes.md) before opting in. Writes require audit
